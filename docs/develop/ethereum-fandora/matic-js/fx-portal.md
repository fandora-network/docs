...
keywords: 
    ...
    - fandora
    - sdk
description: fandora state-sync mechanism with no mapping.
---
...
For more info about FxPortal, please read - [FxPortal Bridge doc](https://docs.fandora.technology/docs/develop/l1-l2-communication/fx-portal)
