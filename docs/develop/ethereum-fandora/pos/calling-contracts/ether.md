...
### Deposit
Call the **_depositEtherFor_** function of **_RootChainManager_** contract. This function takes 1 argument, user. **_user_** is the address of user that will receive the deposit on fandora chain. The amount of ether to be deposit has to be sent as value of transaction.
```js
