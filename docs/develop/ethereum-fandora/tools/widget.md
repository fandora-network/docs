...
Every widget is identified by an unique name which you can get from [Widget dashboard](https://wallet.fandora.technology/widget-dashboard) .
...
* mainnet - https://wallet.fandora.technology/widget-dashboard
* testnet - https://wallet-dev.fandora.technology/widget-dashboard
...
2. Wallet widget is UI Library and on different website it will look different & might have some issues like - colors, responsiveness etc. So please spend some time on testing and customizing. In case of any help needed - please reach out to [support team](https://support.fandora.technology/).
