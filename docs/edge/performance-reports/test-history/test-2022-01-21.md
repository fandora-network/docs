...
This test was done after the TxPool refactor which significantly improved performance (released in [v0.2.0](https://github.com/0xfandora/fandora-edge/releases/v0.2.0)).
    ...
    <div>
        <table>
            <tr>
                ...
                <td>Commit <a href="https://github.com/0xfandora/fandora-edge/commit/8377162281d1a2e4342ae27cd4e5367c4364aee2">8377162281d1a2e4342ae27cd4e5367c4364aee2</a> on develop branch</td>
            </tr>
            <tr>
